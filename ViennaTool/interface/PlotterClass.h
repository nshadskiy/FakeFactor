...
class PlotterClass{
 public:
  ...
  Int_t plotFF(const TString FF_file_CR,const TString FF_file_SR,const int mode,const TString plotfile, const TString n1="CR", const TString n2="SR", const Double_t* xbins=0, const Int_t xbins_size=0, const TString xlabel="");
  ...
  void doBlinding(TH1D* hdata, TH1D *hsum, TH1D *hsignal);
