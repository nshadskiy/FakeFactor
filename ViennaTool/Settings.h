...
const TString analysis      ="2016_ff_v15";
const TString output_folder ="/ceph/jbechtel/2016_ff_v15";
const TString ver = "2016_v15"; // first time nanoAODv5 with deepTauIDv2 
