...
void FFCalculator::calc_nonclosure_QCD_lepPt(const Int_t mode, const TString raw_ff, const TString compare_file, TString ff_output, const TString tight_cat, const Int_t doPlot, const Int_t subtractMC, const Int_t tau_ind){
  ...
  // fill the fits to the raw FFs in the vector fittedFFs. ToDo: Why is dm1 also needed - without it get segfault
  vector<TGraphAsymmErrors*> fittedFFs;
  TGraphAsymmErrors *dm0njet0 = (TGraphAsymmErrors*) FF_lookup.Get("dm0_njet0dR0"+tight_cat); fittedFFs.push_back(dm0njet0);
  TGraphAsymmErrors *dm1njet0 = (TGraphAsymmErrors*) FF_lookup.Get("dm1_njet0dR0"+tight_cat); fittedFFs.push_back(dm1njet0);
  TGraphAsymmErrors *dm0njet1 = (TGraphAsymmErrors*) FF_lookup.Get("dm0_njet1dR0"+tight_cat); fittedFFs.push_back(dm0njet1);
  TGraphAsymmErrors *dm1njet1 = (TGraphAsymmErrors*) FF_lookup.Get("dm1_njet1dR0"+tight_cat); fittedFFs.push_back(dm1njet1);
  
  TGraphAsymmErrors *dm0njet2 = (TGraphAsymmErrors*) FF_lookup.Get("dm0_njet2dR0"+tight_cat); fittedFFs.push_back(dm0njet2);
  TGraphAsymmErrors *dm1njet2 = (TGraphAsymmErrors*) FF_lookup.Get("dm1_njet2dR0"+tight_cat); fittedFFs.push_back(dm1njet2);
