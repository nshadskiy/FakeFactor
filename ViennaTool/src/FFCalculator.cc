...
void FFCalculator::calc_nonclosure_TT_lepPt(const Int_t mode, const TString raw_ff, const TString compare_file, TString ff_output, const TString tight_cat, const Int_t doPlot, const Int_t subtractMC, const Int_t tau_ind){
  ...
  TH1D *closure_h;
  if(mode & _TT) closure_h= new TH1D("closure"+sample,"",w_lepPt_n,w_lepPt_v); // closure plot 15 bins between [0,250]
  else closure_h= new TH1D("closure"+sample,"",w_mvis_n,w_mvis_v); // closure plot with binning {0,30,40,50,60,70,80,90,100,110,120,130,140,150,160,170,180,190,200,225,250,300,350,450}
