...
if [ -d "/ceph/$user/auto-nmssm-jet-fakefactors/$fftype/preselection" ]; then
    if [ ! -d "/ceph/$user/auto-nmssm-jet-fakefactors/$fftype/preselection/mt" ]; then
        mkdir -p /ceph/$user/auto-nmssm-jet-fakefactors/$fftype/preselection/mt
    fi
    if [ ! -d "/ceph/$user/auto-nmssm-jet-fakefactors/$fftype/preselection/et" ]; then
        mkdir -p /ceph/$user/auto-nmssm-jet-fakefactors/$fftype/preselection/et
    fi
    if [ ! -d "/ceph/$user/auto-nmssm-jet-fakefactors/$fftype/preselection/tt" ]; then
        mkdir -p /ceph/$user/auto-nmssm-jet-fakefactors/$fftype/preselection/tt
    fi
else
    mkdir -p /ceph/$user/auto-nmssm-jet-fakefactors/$fftype/preselection/mt
    mkdir -p /ceph/$user/auto-nmssm-jet-fakefactors/$fftype/preselection/et
