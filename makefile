...
all: NtupleClass.o SignalClass.o GlobalClass.o TNtupleAnalyzer.o TSelectionAnalyzer.o PlotterClass.o FFCalculator.o test Preselection SRHisto CRHisto steerFF
