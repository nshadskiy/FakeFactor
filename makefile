...
all: NtupleClass.o SignalClass.o GlobalClass.o TNtupleAnalyzer.o TSelectionAnalyzer.o PlotterClass.o GaussianKernelSmoother.o FFCalculator.o test Preselection SRHisto CRHisto steerFF convert_inputs ApplyFF ApplyUncertainties
...
clean:
	rm *.o test Preselection SRHisto CRHisto convert_inputs ApplyFF
